...
We've used a lot of apps over the years. These are the ones still on our phones:

**Freecampsites.net** — Our go-to for dispersed camping. No frills, user-submitted, and the reviews are honest.

**iOverlander** — Best for BLM land and international spots. We used this constantly in the early years and still check it when we're somewhere new.

**The Dyrt** — Good for campground reviews and finding last-minute spots. The pro version has offline maps, which has saved us more than once.

**Campendium** — Great reviews, especially for cell signal info at specific sites. When you work from the road, knowing you'll have service matters more than knowing there's a fire ring.
...
If you want the honest, detailed breakdown of how van power actually works, what's worth it, and how to size a system for your life, that's what Jesse built [Create a Van Life](https://www.createavanlife.com/) for.
